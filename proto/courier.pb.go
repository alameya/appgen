...
type CourierTime struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Id курьера
	Id int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	// Timestamp в ms
	Time int64 `protobuf:"varint,2,opt,name=time,proto3" json:"time,omitempty"`
	// Актуальны ли координаты курьера
	CoordsExpired bool `protobuf:"varint,3,opt,name=coords_expired,json=coordsExpired,proto3" json:"coords_expired,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CourierTime) Reset() {
	*x = CourierTime{}
...
func (x *CourierTime) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CourierTime) ProtoMessage() {}

func (x *CourierTime) ProtoReflect() protoreflect.Message {
	mi := &file_proto_courier_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CourierTime.ProtoReflect.Descriptor instead.
func (*CourierTime) Descriptor() ([]byte, []int) {
	return file_proto_courier_proto_rawDescGZIP(), []int{1}
}

func (x *CourierTime) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *CourierTime) GetTime() int64 {
	if x != nil {
		return x.Time
	}
	return 0
...
func (x *CourierTime) GetCoordsExpired() bool {
	if x != nil {
		return x.CoordsExpired
	}
	return false
}
...
var file_proto_courier_proto_rawDesc = string([]byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x63, 0x6f, 0x75, 0x72, 0x69, 0x65, 0x72, 0x22, 0x71,
	...
	0x73, 0x22, 0x58, 0x0a, 0x0b, 0x43, 0x6f, 0x75, 0x72, 0x69, 0x65, 0x72, 0x54, 0x69, 0x6d, 0x65,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64,
	0x12, 0x12, 0x0a, 0x04, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04,
	0x74, 0x69, 0x6d, 0x65, 0x12, 0x25, 0x0a, 0x0e, 0x63, 0x6f, 0x6f, 0x72, 0x64, 0x73, 0x5f, 0x65,
	0x78, 0x70, 0x69, 0x72, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x63, 0x6f,
	0x6f, 0x72, 0x64, 0x73, 0x45, 0x78, 0x70, 0x69, 0x72, 0x65, 0x64, 0x42, 0x11, 0x5a, 0x0f, 0x67,
	0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06,
...
var file_proto_courier_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_courier_proto_goTypes = []any{
	(*Courier)(nil),     // 0: courier.Courier
	(*CourierTime)(nil), // 1: courier.CourierTime
}
